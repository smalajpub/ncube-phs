...
function convert(base_url, currentUrl) {
    ...
    if (currentUrl.substring(0, 1) !== "/" && base_url.substring(base_url.length - 1) !== "/") {
        ...
        try {
            ...
            if (debug) console.log('DEBUG: wrong URL completion, link: ' + currentUrl +" (baseUrl: " + base_url + ")");
            return "#";
        }
    }
}
